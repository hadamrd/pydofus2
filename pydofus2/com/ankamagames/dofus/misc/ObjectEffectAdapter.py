...
from pydofus2.com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceDate import EffectInstanceDate
from pydofus2.com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceDice import EffectInstanceDice
from pydofus2.com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceDuration import EffectInstanceDuration
from pydofus2.com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceInteger import EffectInstanceInteger
from pydofus2.com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceLadder import EffectInstanceLadder
from pydofus2.com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceMinMax import EffectInstanceMinMax
from pydofus2.com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceMount import EffectInstanceMount
from pydofus2.com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceString import EffectInstanceString
...
from pydofus2.com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectDate import ObjectEffectDate
from pydofus2.com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectDice import ObjectEffectDice
...
from pydofus2.com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectLadder import ObjectEffectLadder
from pydofus2.com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectMinMax import ObjectEffectMinMax
from pydofus2.com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectMount import ObjectEffectMount
from pydofus2.com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectString import ObjectEffectString
