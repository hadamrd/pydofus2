from pydofus2.com.ankamagames.dofus.network.messages.queues.LoginQueueStatusMessage import LoginQueueStatusMessage
from pydofus2.com.ankamagames.dofus.network.messages.queues.QueueStatusMessage import QueueStatusMessage
