...
from pydofus2.com.ankamagames.dofus.datacenter.monsters.AnimFunMonsterData import AnimFunMonsterData
...
class Monster:
    ...
    def canAttack(self) -> bool:
        if self.aggressiveImmunityCriterion:
            from pydofus2.com.ankamagames.dofus.datacenter.items.criterion import GroupItemCriterion
